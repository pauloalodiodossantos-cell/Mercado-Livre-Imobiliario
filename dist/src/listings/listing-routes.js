...
exports.buildListingRoutes = void 0;
...
const buildListingRoutes = (authService, listingService, offerService) => {
    ...
    router.post("/", (0, auth_middleware_1.requireAuth)(authService), (0, auth_middleware_1.requireRole)("SELLER"), async (req, res) => {
        try {
    ...
    router.post("/:listingId/offers", (0, auth_middleware_1.requireAuth)(authService), (0, auth_middleware_1.requireRole)("BUYER", "BROKER"), async (req, res) => {
        try {
...
exports.buildListingRoutes = buildListingRoutes;
